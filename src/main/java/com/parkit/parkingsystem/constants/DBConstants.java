...
public class DBConstants {
    ...
    public static final String UPDATE_PARKING_SPOT = "update parking set available = ? where PARKING_NUMBER = ? and TYPE = ?";
    ...
    public static final String COUNT_TICKET_FROM_REG_NUMBER = "select count(*) from ticket where VEHICLE_REG_NUMBER=?";
